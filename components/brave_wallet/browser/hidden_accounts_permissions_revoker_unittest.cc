...
class MockKeyringService : public KeyringService {
 public:
  MockKeyringService(PrefService* profile_prefs, PrefService* local_state)
      : KeyringService(/*json_rpc_service=*/nullptr,
                       profile_prefs,
                       local_state) {}
...
class BraveWalletHiddenAccountsPermissionsRevokerUnitTest
    : public testing::Test {
 public:
  BraveWalletHiddenAccountsPermissionsRevokerUnitTest() {
...
TEST_F(BraveWalletHiddenAccountsPermissionsRevokerUnitTest,
  ...
  EXPECT_CALL(keyring_service, GetHiddenAccountsSync())
      .Times(2)
      .WillOnce([&]() { return std::vector<mojom::AccountInfoPtr>{}; })
      .WillOnce([&]() {
  ...
  BraveWalletHiddenAccountsPermissionsRevoker revoker(keyring_service,
                                                      delegate);
